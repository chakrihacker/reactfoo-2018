...
const code = {
	...
	subscription1: require("raw-loader!../assets/subscription1.example"),
	subscription2: require("raw-loader!../assets/subscription2.example"),
	subscription: require("raw-loader!../assets/subscription.example"),
}
	...
	render() {
		return (
			<Deck
				...
				theme={theme}
				progress="bar">
				<Slide bgColor="black" transition={["fade"]} controlColor={"black"}>
					<Loading />
				</Slide>
            ...
            /> */}
						<List textColor={"white"}>
							<Appear>
								<ListItem>React Native Dev at platify</ListItem>
							</Appear>
							<Appear>
								<ListItem>Always bet on JavaScript</ListItem>
							</Appear>
							<Appear>
								<ListItem>FreeCodeCamp, React</ListItem>
							</Appear>
							<Appear>
								<ListItem>React Native, GraphQL</ListItem>
							</Appear>
						</List>
					</Layout>
					<Me />
          ...
          <Heading textColor="primary"> @chakrihacker </Heading>
				...
				<Slide bgColor="black" transition={["zoom"]}>
					<Heading textColor="tomato"> Agenda </Heading>
					<List>
						<Appear>
				...
				<Slide bgColor="black">
					<Heading textColor="tomato" padding="20px" size="4">
						Usage
					</Heading>
					<CodePane lang="js" source={code.errorboundaryUsage} textSize="25" />
				</Slide>
				<Slide bgImage={images.smart} bgDarken="0.5">
				...
				<Slide bgColor="black" textColor="white">
					<Heading textColor="tomato" size="3">
				...
				<Slide bgColor="black" textColor="white">
					<Heading textColor="tomato">Refs timeline</Heading>
					<List>
						<Appear>
				...
				<Slide bgColor="black" textColor="white">
					<Heading textColor="tomato"> Render props </Heading>
					<Text textColor="white">
				...
				<Slide bgColor="black">
					<Heading size="3" textColor="red" padding="0.5em">
						New Context API
					</Heading>
				...
				<Slide bgColor="black">
					...
					<Appear>
						<List textColor="tomato" style={{ paddingLeft: "250px" }}>
				...
				<Slide bgColor="black">
					<Heading size="3" textColor="tomato" blink>
						Let's talk about Future
					</Heading>
				</Slide>
				<Slide bgColor="black">
					<Heading textSize="60" textColor="tomato" padding="10px">
						Create Subscription
					</Heading>
					<CodePane lang="jsx" source={code.subscription1} textSize="20" />
				</Slide>
				<Slide bgColor="black" padding="10px">
					<Heading textSize="60" textColor="tomato">
						Usage
					</Heading>
					<CodePane lang="jsx" source={code.subscription2} textSize="25" />
				</Slide>
				<Slide bgColor="black">
					<ComponentPlayground
						code={code.subscription}
						scope={{ React, createSubscription, BehaviorSubject }}
					/>
				</Slide>
				<Slide bgColor="black">
					<Heading size="3" textColor="tomato">
						Strict Mode
					</Heading>
					<CodePane lang="jsx" source={code.strictMode} textSize="20" />
				</Slide>
				<Slide bgColor="black">
					<Heading textColor="tomato"> Warnings </Heading>
					<Image src={images.strictMode} width="100%" />
				</Slide>
				<Slide bgColor="black">
					<Heading textColor="tomato" margin="30">
						Migration
					</Heading>
					<Appear>
				...
				<Slide bgColor="black" textColor="white">
					...
					<List>
						...
						<ListItem>
							<strike> create-subscription</strike>
						</ListItem>
					</List>
				</Slide>
				<Slide bgColor="black" textColor="white">
					...
					<List>
						<ListItem>What Font is that?</ListItem>
						<ListItem>What editor is that?</ListItem>
						<ListItem>What font size is that?</ListItem>
						<ListItem>What theme so you use?</ListItem>
					</List>
				</Slide>
			</Deck>
		)
